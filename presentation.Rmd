...
>The Cnr of Pelham and Leicester St and 87-89 Grattan St are the __least__ windy areas over the year as they are consistently __below__ the yearly average wind speed.
...
So if wind speed is not impacted by 🔥  then what?

We think the wind speed might be impacted by the location of 🌲  and buildings around Melbourne. 
...
> 87-89 Grattan St and the Cnr of Pelham and Leiscester St are less windier than the other spots

Notice from the map:

> This sensors are sit in between two parks with lots of trees which could explain the lower wind speed.

> 87-89 Grattan St and the Cnr of Pelham and Leiscester St have low wind speeds and are protected by a large cluster of trees.
...
#### 87-89 Grattan St and the Cnr of Leicester and Pelham St have a below average wind speed, comparative to other locations.

#### 87-89 Grattan St and the Cnr of Leicester and Pelham St have more trees than the three sensors clustered together.
...
knitr::include_graphics("images/qr_em.png") #<<
```
]]
.column.bg-main1[.content[
